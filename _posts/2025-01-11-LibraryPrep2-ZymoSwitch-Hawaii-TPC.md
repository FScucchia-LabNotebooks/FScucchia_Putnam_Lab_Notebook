...
## Qubit Results
I used High Sensitivity dsDNA Qubit Protocol linked above. DNA samples were read twice, standard only read once.
- Standard 1: 70.26
- Standard 2: 26525.05
...
![LibPrepRun2_complete.png](https://github.com/FScucchia-LabNotebooks/FScucchia_Putnam_Lab_Notebook/blob/master/images/LibPrepRun2_complete.png?raw=true)
 ...
 - _Things to consider for next time_: Increasing the number of PCR cycles seemed to have imporved the output (better peak profile in TapeStation result), next time I will try with 21 cycles.
